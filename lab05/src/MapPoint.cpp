...
MapPoint::MapPoint(const double latitude, const double longitude)
{
    NMapPoint++;
...
double MapPoint::distanceVal(MapPoint mp) const
{
    double dist1 = sqrt(pow(this->latitude-mp.latitude,2)+pow(this->longitude-mp.longitude,2));
